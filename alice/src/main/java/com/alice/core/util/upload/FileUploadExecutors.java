...
/**
 * Executors are used in entire FileUploader internal for managing different threads.
 * <p>
 * All thread pools in FileUploader will comply with:
 * <p>
 ...
 */
public class FileUploadExecutors {
    private final static int DEFAULT_IDLE_SECOND = 5;
    private final static String FILEDOWNLOADER_PREFIX = "FileUploader";
